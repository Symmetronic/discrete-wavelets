...
- Put the following script tag `<script src='https://unpkg.com/discrete-wavelets@5.0.0/dist/discrete-wavelets.umd.js'></script>` in the head of your index.html
- Then you can use the library in your code.
